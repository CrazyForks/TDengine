...
#undef TD_MSG_SEG_CODE_
  ...
  TD_DEF_MSG_TYPE(TDMT_MND_GET_STREAM_PROGRESS, "stream-get-progress", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_SND_BATCH_META, "snode-batch-meta", NULL, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_MND_KILL_SCAN, "kill-scan", SKillScanReq, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_SCAN_TIMER, "scan-tmr", NULL, NULL)
...
//  TD_DEF_MSG_TYPE(TDMT_MND_TMQ_CONSUMER_LOST, "consumer-lost", SMqConsumerLostMsg, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_MND_RECALC_STREAM, "recalculate-stream", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_UNUSED4, "mnd-unused4", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_UNUSED5, "mnd-unused5", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_UNUSED6, "mnd-unused6", NULL, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_MND_SSMIGRATE_DB, "ssmigrate-db", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_SSMIGRATE_DB_TIMER, "ssmigrate-db-tmr", NULL, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_MND_UNUSEDb, "mnd-unusedb", NULL, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_VND_ALTER_RSMA, "vnode-alter-rsma", NULL, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_VND_ALTER_ELECTBASELINE, "alter-elect-baseline", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_VND_KILL_TRIM, "kill-trim", NULL, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_STREAM_FETCH, "stream-fetch", NULL, NULL)  //1025 1026
  TD_DEF_MSG_TYPE(TDMT_STREAM_FETCH_FROM_CACHE, "stream-fetch-cache", NULL, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_STREAM_UNUSED2, "stream-unused2", NULL, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_STREAM_CHKPT_EXEC, "stream-exec-chkpt", NULL, NULL)  //1059 1060
  TD_DEF_MSG_TYPE(TDMT_STREAM_TASK_START, "stream-task-start", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_STREAM_TRIGGER_CTRL, "stream-trigger-ctl", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_STREAM_TRIGGER_PULL, "stream-trigger-pull", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_STREAM_TRIGGER_CALC, "stream_trigger-calc", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_STREAM_FETCH_FROM_RUNNER, "stream-fetch-runner", NULL, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_VND_STREAM_UNUSED1, "vnd-stream-unused1", NULL, NULL)
  ...
  TD_NEW_MSG_SEG(TDMT_MND_EXT_MSG)  //9 << 8
  ...
  TD_DEF_MSG_TYPE(TDMT_MND_CREATE_MOUNT, "create-mount", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_DROP_MOUNT, "drop-mount", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_EXECUTE_MOUNT, "execute-mount", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_CREATE_RSMA, "create-rsma", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_DROP_RSMA, "drop-rsma", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_GET_RSMA, "get-rsma", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_QUERY_TRIM_TIMER, "query-trim-tmr", NULL, NULL)
