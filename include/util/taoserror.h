...
// xnode
#define TSDB_CODE_MND_XNODE_ALREADY_EXIST       TAOS_DEF_ERROR_CODE(0, 0x0460)
#define TSDB_CODE_MND_XNODE_NOT_EXIST           TAOS_DEF_ERROR_CODE(0, 0x0461)
#define TSDB_CODE_MND_XNODE_TOO_LONG_URL        TAOS_DEF_ERROR_CODE(0, 0x0462)
#define TSDB_CODE_MND_XNODE_INVALID_PROTOCOL    TAOS_DEF_ERROR_CODE(0, 0x0463)
#define TSDB_CODE_MND_XNODE_INVALID_VERSION     TAOS_DEF_ERROR_CODE(0, 0x0464)
#define TSDB_CODE_MND_XNODE_INVALID_MSG         TAOS_DEF_ERROR_CODE(0, 0x0465)
// xnode-p1: task
#define TSDB_CODE_MND_XNODE_TASK_ALREADY_EXIST       TAOS_DEF_ERROR_CODE(0, 0x0470)
#define TSDB_CODE_MND_XNODE_TASK_NAME_TOO_LONG       TAOS_DEF_ERROR_CODE(0, 0x0471)
// xnode-p2: task job
#define TSDB_CODE_MND_XNODE_JOB_SYNTAX_ERROR         TAOS_DEF_ERROR_CODE(0, 0x0480)
#define TSDB_CODE_MND_XNODE_TASK_JOB_CONFIG_TOO_LONG TAOS_DEF_ERROR_CODE(0, 0x0481)
